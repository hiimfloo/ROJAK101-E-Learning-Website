<%@ Page Title="Social" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Social.aspx.cs" Inherits="User_Social" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="carousel-container">
        <h1>Malaysian Social Norms</h1>

        <asp:Repeater ID="rptLessonContent" runat="server">
            <ItemTemplate>
                <div class="carousel-slide">
                    <div class="slide-card">
                        <img src='<%# Eval("ImagePath") %>' alt="Social Norm Image" />
